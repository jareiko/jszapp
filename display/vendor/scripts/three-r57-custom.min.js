...
d[5],J=d[9],E=d[13],X=d[2],A=d[6],S=d[10],F=d[14],H=d[3],K=d[7],N=d[11],d=d[15];e[0]=f*u+g*w+h*X+i*H;e[4]=f*B+g*I+h*A+i*K;e[8]=f*G+g*J+h*S+i*N;e[12]=f*D+g*E+h*F+i*d;e[1]=k*u+l*w+m*X+p*H;e[5]=k*B+l*I+m*A+p*K;e[9]=k*G+l*J+m*S+p*N;e[13]=k*D+l*E+m*F+p*d;e[2]=s*u+r*w+n*X+q*H;e[6]=s*B+r*I+n*A+q*K;e[10]=s*G+r*J+n*S+q*N;e[14]=s*D+r*E+n*F+q*d;e[3]=z*u+t*w+x*X+c*H;e[7]=z*B+t*I+x*A+c*K;e[11]=z*G+t*J+x*S+c*N;e[15]=z*D+t*E+x*F+c*d;return this},multiplyToArray:function(a,b,c){var d=this.elements;this.multiplyMatrices(a,
...
c)return!1;a.lerp(b,c);b.lerp(a,1-d);return!0}var e,f,g=[],h=0,i,k,l=[],m=0,p,s,r=[],n=0,q,z=[],t=0,x,u,B=[],G=0,D,w,I=[],J=0,E={objects:[],sprites:[],lights:[],elements:[]},X=new THREE.Vector3,A=new THREE.Vector4,S=new THREE.Box3(new THREE.Vector3(-1,-1,-1),new THREE.Vector3(1,1,1)),F=new THREE.Box3,H=Array(3),K=Array(4),N=new THREE.Matrix4,fa=new THREE.Matrix4,ma,eb=new THREE.Matrix4,M=new THREE.Matrix3,U=new THREE.Matrix3,ja=new THREE.Vector3,L=new THREE.Frustum,ca=new THREE.Vector4,ta=new THREE.Vector4;
...
c)};this.projectScene=function(g,h,m,db){var La=!1,Oa,ea,ha,V,Z,aa,ia,ra,na,Pa,Ba,fb,jb;w=u=q=s=0;E.elements.length=0;g.updateMatrixWorld();void 0===h.parent&&h.updateMatrixWorld();N.copy(h.matrixWorldInverse.getInverse(h.matrixWorld));fa.multiplyMatrices(h.projectionMatrix,N);U.getInverse(N);U.transpose();L.setFromMatrix(fa);f=0;E.objects.length=0;E.sprites.length=0;E.lights.length=0;var Sa=function(b){for(var c=0,d=b.children.length;c<d;c++){var f=b.children[c];if(!1!==f.visible){if(f instanceof
THREE.Light)E.lights.push(f);else if(f instanceof THREE.Mesh||f instanceof THREE.Line){if(!1===f.frustumCulled||!0===L.intersectsObject(f))e=a(),e.object=f,null!==f.renderDepth?e.z=f.renderDepth:(X.getPositionFromMatrix(f.matrixWorld),X.applyProjection(fa),e.z=X.z),E.objects.push(e)}else f instanceof THREE.Sprite||f instanceof THREE.Particle?(e=a(),e.object=f,null!==f.renderDepth?e.z=f.renderDepth:(X.getPositionFromMatrix(f.matrixWorld),X.applyProjection(fa),e.z=X.z),E.sprites.push(e)):(e=a(),e.object=
f,null!==f.renderDepth?e.z=f.renderDepth:(X.getPositionFromMatrix(f.matrixWorld),X.applyProjection(fa),e.z=X.z),E.objects.push(e));Sa(f)}}};Sa(g);!0===m&&E.objects.sort(c);g=0;for(m=E.objects.length;g<m;g++)if(ra=E.objects[g].object,ma=ra.matrixWorld,k=0,ra instanceof THREE.Mesh){na=ra.geometry;ha=na.vertices;Pa=na.faces;na=na.faceVertexUvs;M.getInverse(ma);M.transpose();fb=ra.material instanceof THREE.MeshFaceMaterial;jb=!0===fb?ra.material:null;Oa=0;for(ea=ha.length;Oa<ea;Oa++)i=b(),i.positionWorld.copy(ha[Oa]).applyMatrix4(ma),
i.positionScreen.copy(i.positionWorld).applyMatrix4(fa),i.positionScreen.x/=i.positionScreen.w,i.positionScreen.y/=i.positionScreen.w,i.positionScreen.z/=i.positionScreen.w,i.visible=!(-1>i.positionScreen.x||1<i.positionScreen.x||-1>i.positionScreen.y||1<i.positionScreen.y||-1>i.positionScreen.z||1<i.positionScreen.z);ha=0;for(Oa=Pa.length;ha<Oa;ha++){ea=Pa[ha];var ob=!0===fb?jb.materials[ea.materialIndex]:ra.material;if(void 0!==ob){aa=ob.side;if(ea instanceof THREE.Face3)if(V=l[ea.a],Z=l[ea.b],
ia=l[ea.c],H[0]=V.positionScreen,H[1]=Z.positionScreen,H[2]=ia.positionScreen,!0===V.visible||!0===Z.visible||!0===ia.visible||S.isIntersectionBox(F.setFromPoints(H)))if(La=0>(ia.positionScreen.x-V.positionScreen.x)*(Z.positionScreen.y-V.positionScreen.y)-(ia.positionScreen.y-V.positionScreen.y)*(Z.positionScreen.x-V.positionScreen.x),aa===THREE.DoubleSide||La===(aa===THREE.FrontSide))s===n?(Ba=new THREE.RenderableFace3,r.push(Ba),n++,s++,p=Ba):p=r[s++],p.v1.copy(V),p.v2.copy(Z),p.v3.copy(ia);else continue;
else continue;else if(ea instanceof THREE.Face4)if(V=l[ea.a],Z=l[ea.b],ia=l[ea.c],Ba=l[ea.d],K[0]=V.positionScreen,K[1]=Z.positionScreen,K[2]=ia.positionScreen,K[3]=Ba.positionScreen,!0===V.visible||!0===Z.visible||!0===ia.visible||!0===Ba.visible||S.isIntersectionBox(F.setFromPoints(K)))if(La=0>(Ba.positionScreen.x-V.positionScreen.x)*(Z.positionScreen.y-V.positionScreen.y)-(Ba.positionScreen.y-V.positionScreen.y)*(Z.positionScreen.x-V.positionScreen.x)||0>(Z.positionScreen.x-ia.positionScreen.x)*
(Ba.positionScreen.y-ia.positionScreen.y)-(Z.positionScreen.y-ia.positionScreen.y)*(Ba.positionScreen.x-ia.positionScreen.x),aa===THREE.DoubleSide||La===(aa===THREE.FrontSide)){if(q===t){var Gb=new THREE.RenderableFace4;z.push(Gb);t++;q++;p=Gb}else p=z[q++];p.v1.copy(V);p.v2.copy(Z);p.v3.copy(ia);p.v4.copy(Ba)}else continue;else continue;p.normalModel.copy(ea.normal);!1===La&&(aa===THREE.BackSide||aa===THREE.DoubleSide)&&p.normalModel.negate();p.normalModel.applyMatrix3(M).normalize();p.normalModelView.copy(p.normalModel).applyMatrix3(U);
p.centroidModel.copy(ea.centroid).applyMatrix4(ma);ia=ea.vertexNormals;V=0;for(Z=ia.length;V<Z;V++)Ba=p.vertexNormalsModel[V],Ba.copy(ia[V]),!1===La&&(aa===THREE.BackSide||aa===THREE.DoubleSide)&&Ba.negate(),Ba.applyMatrix3(M).normalize(),p.vertexNormalsModelView[V].copy(Ba).applyMatrix3(U);p.vertexNormalsLength=ia.length;V=0;for(Z=na.length;V<Z;V++)if(Ba=na[V][ha],void 0!==Ba){aa=0;for(ia=Ba.length;aa<ia;aa++)p.uvs[V][aa]=Ba[aa]}p.color=ea.color;p.material=ob;ja.copy(p.centroidModel).applyProjection(fa);
p.z=ja.z;E.elements.push(p)}}}else if(ra instanceof THREE.Line){eb.multiplyMatrices(fa,ma);ha=ra.geometry.vertices;V=b();V.positionScreen.copy(ha[0]).applyMatrix4(eb);Pa=ra.type===THREE.LinePieces?2:1;Oa=1;for(ea=ha.length;Oa<ea;Oa++)V=b(),V.positionScreen.copy(ha[Oa]).applyMatrix4(eb),0<(Oa+1)%Pa||(Z=l[k-2],ca.copy(V.positionScreen),ta.copy(Z.positionScreen),!0===d(ca,ta)&&(ca.multiplyScalar(1/ca.w),ta.multiplyScalar(1/ta.w),u===G?(na=new THREE.RenderableLine,B.push(na),G++,u++,x=na):x=B[u++],x.v1.positionScreen.copy(ca),
...
new a;B=u=0;w={scene:new THREE.Scene,geometries:{},face_materials:{},materials:{},textures:{},objects:{},cameras:{},lights:{},fogs:{},empties:{},groups:{}};if(J.transform&&(E=J.transform.position,a=J.transform.rotation,c=J.transform.scale,E&&w.scene.position.set(E[0],E[1],E[2]),a&&w.scene.rotation.set(a[0],a[1],a[2]),c&&w.scene.scale.set(c[0],c[1],c[2]),E||a||c))w.scene.updateMatrix(),w.scene.updateMatrixWorld();E=function(a){return function(){B-=a;k();l.onLoadComplete()}};for(var X in J.fogs)a=J.fogs[X],
"linear"===a.type?n=new THREE.Fog(0,a.near,a.far):"exp2"===a.type&&(n=new THREE.FogExp2(0,a.density)),a=a.color,n.color.setRGB(a[0],a[1],a[2]),w.fogs[X]=n;for(var A in J.geometries)n=J.geometries[A],n.type in this.geometryHandlerMap&&(u+=1,l.onLoadStart());for(var S in J.objects)n=J.objects[S],n.type&&n.type in this.hierarchyHandlerMap&&(u+=1,l.onLoadStart());G=u;for(A in J.geometries)if(n=J.geometries[A],"cube"===n.type)p=new THREE.CubeGeometry(n.width,n.height,n.depth,n.widthSegments,n.heightSegments,
...
THREE.Scene.prototype.__removeObject=function(a){if(a instanceof THREE.Light){var b=this.__lights.indexOf(a);-1!==b&&this.__lights.splice(b,1)}else a instanceof THREE.Camera||(b=this.__objects.indexOf(a),-1!==b&&(this.__objects.splice(b,1),this.__objectsRemoved.push(a),b=this.__objectsAdded.indexOf(a),-1!==b&&this.__objectsAdded.splice(b,1)));for(b=0;b<a.children.length;b++)this.__removeObject(a.children[b])};THREE.Fog=function(a,b,c){this.name="";this.color=new THREE.Color(a);this.near=void 0!==b?b:1;this.far=void 0!==c?c:1E3};THREE.Fog.prototype.clone=function(){return new THREE.Fog(this.color.getHex(),this.near,this.far)};THREE.FogExp2=function(a,b){this.name="";this.color=new THREE.Color(a);this.density=void 0!==b?b:2.5E-4};THREE.FogExp2.prototype.clone=function(){return new THREE.FogExp2(this.color.getHex(),this.density)};THREE.CanvasRenderer=function(a){function b(a){D!==a&&(D=u.globalAlpha=a)}function c(a){w!==a&&(a===THREE.NormalBlending?u.globalCompositeOperation="source-over":a===THREE.AdditiveBlending?u.globalCompositeOperation="lighter":a===THREE.SubtractiveBlending&&(u.globalCompositeOperation="darker"),w=a)}function d(a){E!==a&&(E=u.lineWidth=a)}function e(a){X!==a&&(X=u.lineCap=a)}function f(a){A!==a&&(A=u.lineJoin=a)}function g(a){I!==a&&(I=u.strokeStyle=a)}function h(a){J!==a&&(J=u.fillStyle=a)}function i(a,
b){if(S!==a||F!==b)u.setLineDash([a,b]),S=a,F=b}console.log("THREE.CanvasRenderer",THREE.REVISION);var k=THREE.Math.smoothstep,a=a||{},l=this,m,p,s,r=new THREE.Projector,n=void 0!==a.canvas?a.canvas:document.createElement("canvas"),q,z,t,x,u=n.getContext("2d"),B=new THREE.Color(0),G=0,D=1,w=0,I=null,J=null,E=null,X=null,A=null,S=null,F=0,H,K,N,fa,ma=new THREE.RenderableVertex,eb=new THREE.RenderableVertex,M,U,ja,L,ca,ta,kb,$a,lb,db,La,Oa,ea=new THREE.Color,ha=new THREE.Color,V=new THREE.Color,Z=new THREE.Color,
aa=new THREE.Color,ia=new THREE.Color,ra=new THREE.Color,na=new THREE.Color,Pa={},Ba={},fb,jb,Sa,ob,Gb,Mb,wb,Nb,Ob,xb,Hb=new THREE.Box2,Qa=new THREE.Box2,Va=new THREE.Box2,wa=new THREE.Color,xa=new THREE.Color,yb=new THREE.Color,pb=new THREE.Vector3,j,mb,vb,Wa,Ga,zb,Ib=16;j=document.createElement("canvas");j.width=j.height=2;mb=j.getContext("2d");mb.fillStyle="rgba(0,0,0,1)";mb.fillRect(0,0,2,2);vb=mb.getImageData(0,0,2,2);Wa=vb.data;Ga=document.createElement("canvas");Ga.width=Ga.height=Ib;zb=Ga.getContext("2d");
...
Oa=E.positionScreen.y,W instanceof THREE.MeshLambertMaterial||W instanceof THREE.MeshPhongMaterial?(ia.copy(W.color),ra.copy(W.emissive),W.vertexColors===THREE.FaceColors&&ia.multiply(oa.color),!1===W.wireframe&&W.shading==THREE.SmoothShading&&4==oa.vertexNormalsLength?(ha.copy(wa),V.copy(wa),Z.copy(wa),aa.copy(wa),q(oa.v1.positionWorld,oa.vertexNormalsModel[0],ha),q(oa.v2.positionWorld,oa.vertexNormalsModel[1],V),q(oa.v4.positionWorld,oa.vertexNormalsModel[3],Z),q(oa.v3.positionWorld,oa.vertexNormalsModel[2],
aa),ha.multiply(ia).add(ra),V.multiply(ia).add(ra),Z.multiply(ia).add(ra),aa.multiply(ia).add(ra),Sa=Dc(ha,V,Z,aa),z(M,U,ja,L,kb,$a),ab(M,U,ja,L,kb,$a,0,0,1,0,0,1,Sa),z(lb,db,ca,ta,La,Oa),ab(lb,db,ca,ta,La,Oa,1,0,1,1,0,1,Sa)):(ea.copy(wa),q(oa.centroidModel,oa.normalModel,ea),ea.multiply(ia).add(ra),A(M,U,ja,L,ca,ta,kb,$a),!0===W.wireframe?B(ea,W.wireframeLinewidth,W.wireframeLinecap,W.wireframeLinejoin):D(ea))):W instanceof THREE.MeshBasicMaterial?(ea.copy(W.color),W.vertexColors===THREE.FaceColors&&
...
ga=oa.vertexNormalsModelView[1],V.setRGB(ga.x,ga.y,ga.z).multiplyScalar(0.5).addScalar(0.5),ga=oa.vertexNormalsModelView[3],Z.setRGB(ga.x,ga.y,ga.z).multiplyScalar(0.5).addScalar(0.5),ga=oa.vertexNormalsModelView[2],aa.setRGB(ga.x,ga.y,ga.z).multiplyScalar(0.5).addScalar(0.5),Sa=Dc(ha,V,Z,aa),z(M,U,ja,L,kb,$a),ab(M,U,ja,L,kb,$a,0,0,1,0,0,1,Sa),z(lb,db,ca,ta,La,Oa),ab(lb,db,ca,ta,La,Oa,1,0,1,1,0,1,Sa))):W instanceof THREE.MeshDepthMaterial&&(fb=n.near,jb=n.far,ha.r=ha.g=ha.b=1-k(ga.positionScreen.z*
ga.positionScreen.w,fb,jb),V.r=V.g=V.b=1-k(gb.positionScreen.z*gb.positionScreen.w,fb,jb),Z.r=Z.g=Z.b=1-k(G.positionScreen.z*G.positionScreen.w,fb,jb),aa.r=aa.g=aa.b=1-k(Ab.positionScreen.z*Ab.positionScreen.w,fb,jb),Sa=Dc(ha,V,Z,aa),z(M,U,ja,L,kb,$a),ab(M,U,ja,L,kb,$a,0,0,1,0,0,1,Sa),z(lb,db,ca,ta,La,Oa),ab(lb,db,ca,ta,La,Oa,1,0,1,1,0,1,Sa)))}Qa.union(Va)}}u.setTransform(1,0,0,1,0,0)}}};THREE.ShaderChunk={fog_pars_fragment:"#ifdef USE_FOG\nuniform vec3 fogColor;\n#ifdef FOG_EXP2\nuniform float fogDensity;\n#else\nuniform float fogNear;\nuniform float fogFar;\n#endif\n#endif",fog_fragment:"#ifdef USE_FOG\nfloat depth = gl_FragCoord.z / gl_FragCoord.w;\n#ifdef FOG_EXP2\nconst float LOG2 = 1.442695;\nfloat fogFactor = exp2( - fogDensity * fogDensity * depth * depth * LOG2 );\nfogFactor = 1.0 - clamp( fogFactor, 0.0, 1.0 );\n#else\nfloat fogFactor = smoothstep( fogNear, fogFar, depth );\n#endif\ngl_FragColor = mix( gl_FragColor, vec4( fogColor, gl_FragColor.w ), fogFactor );\n#endif",
...
(Oa+=1,m.visible&&(ca=3*U,L.gammaInput?G(w,ca,n,q*q):D(w,ca,n,q),wa.getPositionFromMatrix(m.matrixWorld),z[ca]=wa.x,z[ca+1]=wa.y,z[ca+2]=wa.z,A[U]=s,U+=1)):m instanceof THREE.SpotLight?(ia+=1,m.visible&&(ca=3*Z,L.gammaInput?G(B,ca,n,q*q):D(B,ca,n,q),wa.getPositionFromMatrix(m.matrixWorld),E[ca]=wa.x,E[ca+1]=wa.y,E[ca+2]=wa.z,I[Z]=s,xa.copy(wa),wa.getPositionFromMatrix(m.target.matrixWorld),xa.sub(wa),xa.normalize(),J[ca]=xa.x,J[ca+1]=xa.y,J[ca+2]=xa.z,K[Z]=Math.cos(m.angle),M[Z]=m.exponent,Z+=1)):
m instanceof THREE.HemisphereLight&&($a+=1,m.visible&&(xa.getPositionFromMatrix(m.matrixWorld),xa.normalize(),0===xa.x&&0===xa.y&&0===xa.z||(s=3*ha,S[s]=xa.x,S[s+1]=xa.y,S[s+2]=xa.z,n=m.color,m=m.groundColor,L.gammaInput?(q*=q,G(V,s,n,q),G(N,s,m,q)):(D(V,s,n,q),D(N,s,m,q)),ha+=1))));c=3*ta;for(f=Math.max(t.length,3*fa);c<f;c++)t[c]=0;c=3*U;for(f=Math.max(w.length,3*Oa);c<f;c++)w[c]=0;c=3*Z;for(f=Math.max(B.length,3*ia);c<f;c++)B[c]=0;c=3*ha;for(f=Math.max(V.length,3*$a);c<f;c++)V[c]=0;c=3*ha;for(f=
Math.max(N.length,3*$a);c<f;c++)N[c]=0;r.directional.length=ta;r.point.length=U;r.spot.length=Z;r.hemi.length=ha;r.ambient[0]=k;r.ambient[1]=l;r.ambient[2]=p;yb=!1}c=pb;i.ambientLightColor.value=c.ambient;i.directionalLightColor.value=c.directional.colors;i.directionalLightDirection.value=c.directional.positions;i.pointLightColor.value=c.point.colors;i.pointLightPosition.value=c.point.positions;i.pointLightDistance.value=c.point.distances;i.spotLightColor.value=c.spot.colors;i.spotLightPosition.value=
...
i.diffuse.value.copyGammaToLinear(d.color):i.diffuse.value=d.color;i.map.value=d.map;i.lightMap.value=d.lightMap;i.specularMap.value=d.specularMap;d.bumpMap&&(i.bumpMap.value=d.bumpMap,i.bumpScale.value=d.bumpScale);d.normalMap&&(i.normalMap.value=d.normalMap,i.normalScale.value.copy(d.normalScale));var aa;d.offset&&d.repeat?aa=d:d.map?aa=d.map:d.specularMap?aa=d.specularMap:d.normalMap?aa=d.normalMap:d.bumpMap&&(aa=d.bumpMap);void 0!==aa&&(c=aa.offset,aa=aa.repeat,i.offsetRepeat.value.set(c.x,c.y,
aa.x,aa.y));i.envMap.value=d.envMap;i.flipEnvMap.value=d.envMap instanceof THREE.WebGLRenderTargetCube?1:-1;i.reflectivity.value=d.reflectivity;i.refractionRatio.value=d.refractionRatio;i.combine.value=d.combine;i.useRefract.value=d.envMap&&d.envMap.mapping instanceof THREE.CubeRefractionMapping}d instanceof THREE.LineBasicMaterial?(i.diffuse.value=d.color,i.opacity.value=d.opacity):d instanceof THREE.LineDashedMaterial?(i.diffuse.value=d.color,i.opacity.value=d.opacity,i.dashSize.value=d.dashSize,
i.totalSize.value=d.dashSize+d.gapSize,i.scale.value=d.scale):d instanceof THREE.ParticleBasicMaterial?(i.psColor.value=d.color,i.opacity.value=d.opacity,i.size.value=d.size,i.scale.value=H.height/2,i.map.value=d.map):d instanceof THREE.MeshPhongMaterial?(i.shininess.value=d.shininess,L.gammaInput?(i.ambient.value.copyGammaToLinear(d.ambient),i.emissive.value.copyGammaToLinear(d.emissive),i.specular.value.copyGammaToLinear(d.specular)):(i.ambient.value=d.ambient,i.emissive.value=d.emissive,i.specular.value=
...
!d._shadowPass&&i.shadowMatrix){c=aa=0;for(f=b.length;c<f;c++)if(k=b[c],k.castShadow&&(k instanceof THREE.SpotLight||k instanceof THREE.DirectionalLight&&!k.shadowCascade))i.shadowMap.value[aa]=k.shadowMap,i.shadowMapSize.value[aa]=k.shadowMapSize,i.shadowMatrix.value[aa]=k.shadowMatrix,i.shadowDarkness.value[aa]=k.shadowDarkness,i.shadowBias.value[aa]=k.shadowBias,aa++}b=d.uniformsList;i=0;for(aa=b.length;i<aa;i++)if(f=g.uniforms[b[i][1]])if(c=b[i][0],l=c.type,k=c.value,"i"===l)j.uniform1i(f,k);
else if("f"===l)j.uniform1f(f,k);else if("v2"===l)j.uniform2f(f,k.x,k.y);else if("v3"===l)j.uniform3f(f,k.x,k.y,k.z);else if("v4"===l)j.uniform4f(f,k.x,k.y,k.z,k.w);else if("c"===l)j.uniform3f(f,k.r,k.g,k.b);else if("iv1"===l)j.uniform1iv(f,k);else if("iv"===l)j.uniform3iv(f,k);else if("fv1"===l)j.uniform1fv(f,k);else if("fv"===l)j.uniform3fv(f,k);else if("v2v"===l){void 0===c._array&&(c._array=new Float32Array(2*k.length));l=0;for(p=k.length;l<p;l++)r=2*l,c._array[r]=k[l].x,c._array[r+1]=k[l].y;
...
k.flattenToArray(c._array),j.uniformMatrix4fv(f,!1,c._array);else if("m4v"===l){void 0===c._array&&(c._array=new Float32Array(16*k.length));l=0;for(p=k.length;l<p;l++)k[l].flattenToArrayOffset(c._array,16*l);j.uniformMatrix4fv(f,!1,c._array)}else if("t"===l){if(r=k,k=u(),j.uniform1i(f,k),r)if(r.image instanceof Array&&6===r.image.length){if(c=r,f=k,6===c.image.length)if(c.needsUpdate){c.image.__webglTextureCube||(c.image.__webglTextureCube=j.createTexture(),L.info.memory.textures++);j.activeTexture(j.TEXTURE0+
f);j.bindTexture(j.TEXTURE_CUBE_MAP,c.image.__webglTextureCube);j.pixelStorei(j.UNPACK_FLIP_Y_WEBGL,c.flipY);f=c instanceof THREE.CompressedTexture;k=[];for(l=0;6>l;l++)L.autoScaleCubemaps&&!f?(p=k,r=l,t=c.image[l],w=pd,t.width<=w&&t.height<=w||(z=Math.max(t.width,t.height),x=Math.floor(t.width*w/z),w=Math.floor(t.height*w/z),z=document.createElement("canvas"),z.width=x,z.height=w,z.getContext("2d").drawImage(t,0,0,t.width,t.height,0,0,x,w),t=z),p[r]=t):k[l]=c.image[l];l=k[0];p=0===(l.width&l.width-
1)&&0===(l.height&l.height-1);r=F(c.format);t=F(c.type);X(j.TEXTURE_CUBE_MAP,c,p);for(l=0;6>l;l++)if(f){w=k[l].mipmaps;z=0;for(A=w.length;z<A;z++)x=w[z],j.compressedTexImage2D(j.TEXTURE_CUBE_MAP_POSITIVE_X+l,z,r,x.width,x.height,0,x.data)}else j.texImage2D(j.TEXTURE_CUBE_MAP_POSITIVE_X+l,0,r,r,t,k[l]);c.generateMipmaps&&p&&j.generateMipmap(j.TEXTURE_CUBE_MAP);c.needsUpdate=!1;if(c.onUpdate)c.onUpdate()}else j.activeTexture(j.TEXTURE0+f),j.bindTexture(j.TEXTURE_CUBE_MAP,c.image.__webglTextureCube)}else r instanceof
THREE.WebGLRenderTargetCube?(c=r,j.activeTexture(j.TEXTURE0+k),j.bindTexture(j.TEXTURE_CUBE_MAP,c.__webglTexture)):L.setTexture(r,k)}else if("tv"===l){void 0===c._array&&(c._array=[]);l=0;for(p=c.value.length;l<p;l++)c._array[l]=u();j.uniform1iv(f,c._array);l=0;for(p=c.value.length;l<p;l++)r=c.value[l],k=c._array[l],r&&L.setTexture(r,k)}if((d instanceof THREE.ShaderMaterial||d instanceof THREE.MeshPhongMaterial||d.envMap)&&null!==h.cameraPosition)wa.getPositionFromMatrix(a.matrixWorld),j.uniform3f(h.cameraPosition,
...
a+" texture units while this GPU supports only "+Ib);ea+=1;return a}function B(a,b){a._modelViewMatrix.multiplyMatrices(b.matrixWorldInverse,a.matrixWorld);a._normalMatrix.getInverse(a._modelViewMatrix);a._normalMatrix.transpose()}function G(a,b,c,d){a[b]=c.r*c.r*d;a[b+1]=c.g*c.g*d;a[b+2]=c.b*c.b*d}function D(a,b,c,d){a[b]=c.r*d;a[b+1]=c.g*d;a[b+2]=c.b*d}function w(a){a!==Sa&&(j.lineWidth(a),Sa=a)}function I(a,b,c){Ba!==a&&(a?j.enable(j.POLYGON_OFFSET_FILL):j.disable(j.POLYGON_OFFSET_FILL),Ba=a);
if(a&&(fb!==b||jb!==c))j.polygonOffset(b,c),fb=b,jb=c}function J(a){for(var a=a.split("\n"),b=0,c=a.length;b<c;b++)a[b]=b+1+": "+a[b];return a.join("\n")}function E(a,b){var c;"fragment"===a?c=j.createShader(j.FRAGMENT_SHADER):"vertex"===a&&(c=j.createShader(j.VERTEX_SHADER));j.shaderSource(c,b);j.compileShader(c);return!j.getShaderParameter(c,j.COMPILE_STATUS)?(console.error(j.getShaderInfoLog(c)),console.error(J(b)),null):c}function X(a,b,c){c?(j.texParameteri(a,j.TEXTURE_WRAP_S,F(b.wrapS)),j.texParameteri(a,
j.TEXTURE_WRAP_T,F(b.wrapT)),j.texParameteri(a,j.TEXTURE_MAG_FILTER,F(b.magFilter)),j.texParameteri(a,j.TEXTURE_MIN_FILTER,F(b.minFilter))):(j.texParameteri(a,j.TEXTURE_WRAP_S,j.CLAMP_TO_EDGE),j.texParameteri(a,j.TEXTURE_WRAP_T,j.CLAMP_TO_EDGE),j.texParameteri(a,j.TEXTURE_MAG_FILTER,S(b.magFilter)),j.texParameteri(a,j.TEXTURE_MIN_FILTER,S(b.minFilter)));if(Wa&&b.type!==THREE.FloatType&&(1<b.anisotropy||b.__oldAnisotropy))j.texParameterf(a,Wa.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,Wc)),b.__oldAnisotropy=
...
[];this.renderPluginsPost=[];this.info={memory:{programs:0,geometries:0,textures:0},render:{calls:0,vertices:0,faces:0,points:0}};var L=this,ca=[],ta=0,kb=null,$a=null,lb=-1,db=null,La=null,Oa=0,ea=0,ha=-1,V=-1,Z=-1,aa=-1,ia=-1,ra=-1,na=-1,Pa=-1,Ba=null,fb=null,jb=null,Sa=null,ob=0,Gb=0,Mb=0,wb=0,Nb=0,Ob=0,xb={},Hb=new THREE.Frustum,Qa=new THREE.Matrix4,Va=new THREE.Matrix4,wa=new THREE.Vector3,xa=new THREE.Vector3,yb=!0,pb={ambient:[0,0,0],directional:{length:0,colors:[],positions:[]},point:{length:0,
...
Ga||console.log("THREE.WebGLRenderer: S3TC compressed textures not supported.");void 0===j.getShaderPrecisionFormat&&(j.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}});j.clearColor(0,0,0,1);j.clearDepth(1);j.clearStencil(0);j.enable(j.DEPTH_TEST);j.depthFunc(j.LEQUAL);j.frontFace(j.CCW);j.cullFace(j.BACK);j.enable(j.CULL_FACE);j.enable(j.BLEND);j.blendEquation(j.FUNC_ADD);j.blendFunc(j.SRC_ALPHA,j.ONE_MINUS_SRC_ALPHA);j.clearColor(U.r,U.g,U.b,ja);this.context=j;var Ib=
j.getParameter(j.MAX_TEXTURE_IMAGE_UNITS),a=j.getParameter(j.MAX_VERTEX_TEXTURE_IMAGE_UNITS);j.getParameter(j.MAX_TEXTURE_SIZE);var pd=j.getParameter(j.MAX_CUBE_MAP_TEXTURE_SIZE),Wc=Wa?j.getParameter(Wa.MAX_TEXTURE_MAX_ANISOTROPY_EXT):0,Bc=0<a,Cc=Bc&&mb;Ga&&j.getParameter(j.COMPRESSED_TEXTURE_FORMATS);fa=j.getShaderPrecisionFormat(j.VERTEX_SHADER,j.HIGH_FLOAT);a=j.getShaderPrecisionFormat(j.VERTEX_SHADER,j.MEDIUM_FLOAT);j.getShaderPrecisionFormat(j.VERTEX_SHADER,j.LOW_FLOAT);ma=j.getShaderPrecisionFormat(j.FRAGMENT_SHADER,
j.HIGH_FLOAT);N=j.getShaderPrecisionFormat(j.FRAGMENT_SHADER,j.MEDIUM_FLOAT);j.getShaderPrecisionFormat(j.FRAGMENT_SHADER,j.LOW_FLOAT);j.getShaderPrecisionFormat(j.VERTEX_SHADER,j.HIGH_INT);j.getShaderPrecisionFormat(j.VERTEX_SHADER,j.MEDIUM_INT);j.getShaderPrecisionFormat(j.VERTEX_SHADER,j.LOW_INT);j.getShaderPrecisionFormat(j.FRAGMENT_SHADER,j.HIGH_INT);j.getShaderPrecisionFormat(j.FRAGMENT_SHADER,j.MEDIUM_INT);j.getShaderPrecisionFormat(j.FRAGMENT_SHADER,j.LOW_INT);fa=0<fa.precision&&0<ma.precision;
a=0<a.precision&&0<N.precision;"highp"===K&&!fa&&(a?(K="mediump",console.warn("WebGLRenderer: highp not supported, using mediump")):(K="lowp",console.warn("WebGLRenderer: highp and mediump not supported, using lowp")));"mediump"===K&&!a&&(K="lowp",console.warn("WebGLRenderer: mediump not supported, using lowp"));this.getContext=function(){return j};this.supportsVertexTextures=function(){return Bc};this.supportsFloatTextures=function(){return mb};this.supportsStandardDerivatives=function(){return vb};
this.supportsCompressedTextureS3TC=function(){return Ga};this.getMaxAnisotropy=function(){return Wc};this.getPrecision=function(){return K};this.setSize=function(a,b){H.width=a*this.devicePixelRatio;H.height=b*this.devicePixelRatio;H.style.width=a+"px";H.style.height=b+"px";this.setViewport(0,0,H.width,H.height)};this.setViewport=function(a,b,c,d){ob=void 0!==a?a:0;Gb=void 0!==b?b:0;Mb=void 0!==c?c:H.width;wb=void 0!==d?d:H.height;j.viewport(ob,Gb,Mb,wb)};this.setScissor=function(a,b,c,d){j.scissor(a,
...
this.clearTarget=function(a,b,c,d){this.setRenderTarget(a);this.clear(b,c,d)};this.addPostPlugin=function(a){a.init(this);this.renderPluginsPost.push(a)};this.addPrePlugin=function(a){a.init(this);this.renderPluginsPre.push(a)};this.updateShadowMap=function(a,b){kb=null;lb=db=Pa=na=Z=-1;yb=!0;V=ha=-1;this.shadowMapPlugin.update(a,b)};var Bd=function(a){a=a.target;a.removeEventListener("dispose",Bd);a.__webglInit=void 0;void 0!==a.__webglVertexBuffer&&j.deleteBuffer(a.__webglVertexBuffer);void 0!==
...
L.info.memory.geometries--},Zc=function(a){a=a.target;a.removeEventListener("dispose",Zc);a.image&&a.image.__webglTextureCube?j.deleteTexture(a.image.__webglTextureCube):a.__webglInit&&(a.__webglInit=!1,j.deleteTexture(a.__webglTexture));L.info.memory.textures--},Jc=function(a){a=a.target;a.removeEventListener("dispose",Jc);if(a&&a.__webglTexture)if(j.deleteTexture(a.__webglTexture),a instanceof THREE.WebGLRenderTargetCube)for(var b=0;6>b;b++)j.deleteFramebuffer(a.__webglFramebuffer[b]),j.deleteRenderbuffer(a.__webglRenderbuffer[b]);
else j.deleteFramebuffer(a.__webglFramebuffer),j.deleteRenderbuffer(a.__webglRenderbuffer);L.info.memory.textures--},Xc=function(a){a=a.target;a.removeEventListener("dispose",Xc);Yc(a)},Yc=function(a){var b=a.program;if(void 0!==b){a.program=void 0;var c,d,e=!1,a=0;for(c=ca.length;a<c;a++)if(d=ca[a],d.program===b){d.usedTimes--;0===d.usedTimes&&(e=!0);break}if(!0===e){e=[];a=0;for(c=ca.length;a<c;a++)d=ca[a],d.program!==b&&e.push(d);ca=e;j.deleteProgram(b);L.info.memory.programs--}}};this.renderBufferImmediate=
...
e.__webglMorphTargetsBuffers[f.morphTargetBase]),h(c.position),j.vertexAttribPointer(c.position,3,j.FLOAT,!1,0,0)):0<=c.position&&(j.bindBuffer(j.ARRAY_BUFFER,e.__webglVertexBuffer),h(c.position),j.vertexAttribPointer(c.position,3,j.FLOAT,!1,0,0));if(f.morphTargetForcedOrder.length){var m=0;k=f.morphTargetForcedOrder;for(g=f.morphTargetInfluences;m<d.numSupportedMorphTargets&&m<k.length;)0<=c["morphTarget"+m]&&(j.bindBuffer(j.ARRAY_BUFFER,e.__webglMorphTargetsBuffers[k[m]]),h(c["morphTarget"+m]),
j.vertexAttribPointer(c["morphTarget"+m],3,j.FLOAT,!1,0,0)),0<=c["morphNormal"+m]&&d.morphNormals&&(j.bindBuffer(j.ARRAY_BUFFER,e.__webglMorphNormalsBuffers[k[m]]),h(c["morphNormal"+m]),j.vertexAttribPointer(c["morphNormal"+m],3,j.FLOAT,!1,0,0)),f.__webglMorphTargetInfluences[m]=g[k[m]],m++}else{k=[];g=f.morphTargetInfluences;var p,n=g.length;for(p=0;p<n;p++)m=g[p],0<m&&k.push([m,p]);k.length>d.numSupportedMorphTargets?(k.sort(l),k.length=d.numSupportedMorphTargets):k.length>d.numSupportedMorphNormals?
k.sort(l):0===k.length&&k.push([0,0]);for(m=0;m<d.numSupportedMorphTargets;)k[m]?(p=k[m][1],0<=c["morphTarget"+m]&&(j.bindBuffer(j.ARRAY_BUFFER,e.__webglMorphTargetsBuffers[p]),h(c["morphTarget"+m]),j.vertexAttribPointer(c["morphTarget"+m],3,j.FLOAT,!1,0,0)),0<=c["morphNormal"+m]&&d.morphNormals&&(j.bindBuffer(j.ARRAY_BUFFER,e.__webglMorphNormalsBuffers[p]),h(c["morphNormal"+m]),j.vertexAttribPointer(c["morphNormal"+m],3,j.FLOAT,!1,0,0)),f.__webglMorphTargetInfluences[m]=g[p]):f.__webglMorphTargetInfluences[m]=
...
(w(d.wireframeLinewidth),b&&j.bindBuffer(j.ELEMENT_ARRAY_BUFFER,e.__webglLineBuffer),j.drawElements(j.LINES,e.__webglLineCount,j.UNSIGNED_SHORT,0)):(b&&j.bindBuffer(j.ELEMENT_ARRAY_BUFFER,e.__webglFaceBuffer),j.drawElements(j.TRIANGLES,e.__webglFaceCount,j.UNSIGNED_SHORT,0)),L.info.render.calls++,L.info.render.vertices+=e.__webglFaceCount,L.info.render.faces+=e.__webglFaceCount/3):f instanceof THREE.Line?(f=f.type===THREE.LineStrip?j.LINE_STRIP:j.LINES,w(d.linewidth),j.drawArrays(f,0,e.__webglLineCount),
L.info.render.calls++):f instanceof THREE.ParticleSystem?(j.drawArrays(j.POINTS,0,e.__webglParticleCount),L.info.render.calls++,L.info.render.points+=e.__webglParticleCount):f instanceof THREE.Ribbon&&(j.drawArrays(j.TRIANGLE_STRIP,0,e.__webglVertexCount),L.info.render.calls++)}};this.render=function(a,b,c,d){if(!1===b instanceof THREE.Camera)console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");else{var e,f,g,h,i=a.__lights,l=a.fog;lb=-1;yb=!0;this.autoUpdateScene&&
...
0;for(e=h.length;d<e;d++)if(f=h[d],g=f.object,f.render=!1,g.visible&&(!(g instanceof THREE.Mesh||g instanceof THREE.ParticleSystem)||!g.frustumCulled||Hb.intersectsObject(g))){B(g,b);var n=f,q=n.buffer,r=void 0,t=r=void 0,t=n.object.material;if(t instanceof THREE.MeshFaceMaterial)r=q.materialIndex,r=t.materials[r],r.transparent?(n.transparent=r,n.opaque=null):(n.opaque=r,n.transparent=null);else if(r=t)r.transparent?(n.transparent=r,n.opaque=null):(n.opaque=r,n.transparent=null);f.render=!0;!0===
this.sortObjects&&(null!==g.renderDepth?f.z=g.renderDepth:(wa.getPositionFromMatrix(g.matrixWorld),wa.applyProjection(Qa),f.z=wa.z),f.id=g.id)}this.sortObjects&&h.sort(k);h=a.__webglObjectsImmediate;d=0;for(e=h.length;d<e;d++)f=h[d],g=f.object,g.visible&&(B(g,b),g=f.object.material,g.transparent?(f.transparent=g,f.opaque=null):(f.opaque=g,f.transparent=null));a.overrideMaterial?(d=a.overrideMaterial,this.setBlending(d.blending,d.blendEquation,d.blendSrc,d.blendDst),this.setDepthTest(d.depthTest),
this.setDepthWrite(d.depthWrite),I(d.polygonOffset,d.polygonOffsetFactor,d.polygonOffsetUnits),p(a.__webglObjects,!1,"",b,i,l,!0,d),s(a.__webglObjectsImmediate,"",b,i,l,!1,d)):(d=null,this.setBlending(THREE.NoBlending),p(a.__webglObjects,!0,"opaque",b,i,l,!1,d),s(a.__webglObjectsImmediate,"opaque",b,i,l,!1,d),p(a.__webglObjects,!1,"transparent",b,i,l,!0,d),s(a.__webglObjectsImmediate,"transparent",b,i,l,!0,d));m(this.renderPluginsPost,a,b);c&&(c.generateMipmaps&&c.minFilter!==THREE.NearestFilter&&
c.minFilter!==THREE.LinearFilter)&&(c instanceof THREE.WebGLRenderTargetCube?(j.bindTexture(j.TEXTURE_CUBE_MAP,c.__webglTexture),j.generateMipmap(j.TEXTURE_CUBE_MAP),j.bindTexture(j.TEXTURE_CUBE_MAP,null)):(j.bindTexture(j.TEXTURE_2D,c.__webglTexture),j.generateMipmap(j.TEXTURE_2D),j.bindTexture(j.TEXTURE_2D,null)));this.setDepthTest(!0);this.setDepthWrite(!0)}};this.renderImmediateObject=function(a,b,c,d,e){var f=x(a,b,c,d,e);db=-1;L.setMaterialFaces(d);e.immediateRenderCallback?e.immediateRenderCallback(f,
j,Hb):e.render(function(a){L.renderBufferImmediate(a,f,d)})};this.initWebGLObjects=function(a){a.__webglObjects||(a.__webglObjects=[],a.__webglObjectsImmediate=[],a.__webglSprites=[],a.__webglFlares=[]);for(;a.__objectsAdded.length;){var b=a.__objectsAdded[0],h=a,i=void 0,k=void 0,m=void 0,p=void 0;if(!b.__webglInit&&(b.__webglInit=!0,b._modelViewMatrix=new THREE.Matrix4,b._normalMatrix=new THREE.Matrix3,void 0!==b.geometry&&void 0===b.geometry.__webglInit&&(b.geometry.__webglInit=!0,b.geometry.addEventListener("dispose",
Bd)),k=b.geometry,void 0!==k))if(k instanceof THREE.BufferGeometry){var s=k,u=void 0,x=void 0,w=void 0;for(u in s.attributes)w="index"===u?j.ELEMENT_ARRAY_BUFFER:j.ARRAY_BUFFER,x=s.attributes[u],x.buffer=j.createBuffer(),j.bindBuffer(w,x.buffer),j.bufferData(w,x.array,j.STATIC_DRAW)}else if(b instanceof THREE.Mesh){m=b.material;if(void 0===k.geometryGroups){var A=k,B=void 0,D=void 0,F=void 0,E=void 0,G=void 0,H=void 0,I={},J=A.morphTargets.length,K=A.morphNormals.length,M=m instanceof THREE.MeshFaceMaterial;
A.geometryGroups={};B=0;for(D=A.faces.length;B<D;B++)F=A.faces[B],E=M?F.materialIndex:0,void 0===I[E]&&(I[E]={hash:E,counter:0}),H=I[E].hash+"_"+I[E].counter,void 0===A.geometryGroups[H]&&(A.geometryGroups[H]={faces3:[],faces4:[],materialIndex:E,vertices:0,numMorphTargets:J,numMorphNormals:K}),G=F instanceof THREE.Face3?3:4,65535<A.geometryGroups[H].vertices+G&&(I[E].counter+=1,H=I[E].hash+"_"+I[E].counter,void 0===A.geometryGroups[H]&&(A.geometryGroups[H]={faces3:[],faces4:[],materialIndex:E,vertices:0,
numMorphTargets:J,numMorphNormals:K})),F instanceof THREE.Face3?A.geometryGroups[H].faces3.push(B):A.geometryGroups[H].faces4.push(B),A.geometryGroups[H].vertices+=G;A.geometryGroupsList=[];var V=void 0;for(V in A.geometryGroups)A.geometryGroups[V].id=Oa++,A.geometryGroupsList.push(A.geometryGroups[V])}for(i in k.geometryGroups)if(p=k.geometryGroups[i],!p.__webglVertexBuffer){var N=p;N.__webglVertexBuffer=j.createBuffer();N.__webglNormalBuffer=j.createBuffer();N.__webglTangentBuffer=j.createBuffer();
N.__webglColorBuffer=j.createBuffer();N.__webglUVBuffer=j.createBuffer();N.__webglUV2Buffer=j.createBuffer();N.__webglSkinIndicesBuffer=j.createBuffer();N.__webglSkinWeightsBuffer=j.createBuffer();N.__webglFaceBuffer=j.createBuffer();N.__webglLineBuffer=j.createBuffer();var S=void 0,ta=void 0;if(N.numMorphTargets){N.__webglMorphTargetsBuffers=[];S=0;for(ta=N.numMorphTargets;S<ta;S++)N.__webglMorphTargetsBuffers.push(j.createBuffer())}if(N.numMorphNormals){N.__webglMorphNormalsBuffers=[];S=0;for(ta=
N.numMorphNormals;S<ta;S++)N.__webglMorphNormalsBuffers.push(j.createBuffer())}L.info.memory.geometries++;d(p,b);k.verticesNeedUpdate=!0;k.morphTargetsNeedUpdate=!0;k.elementsNeedUpdate=!0;k.uvsNeedUpdate=!0;k.normalsNeedUpdate=!0;k.tangentsNeedUpdate=!0;k.colorsNeedUpdate=!0}}else if(b instanceof THREE.Ribbon){if(!k.__webglVertexBuffer){var ea=k;ea.__webglVertexBuffer=j.createBuffer();ea.__webglColorBuffer=j.createBuffer();ea.__webglNormalBuffer=j.createBuffer();L.info.memory.geometries++;var U=
k,Z=b,ha=U.vertices.length;U.__vertexArray=new Float32Array(3*ha);U.__colorArray=new Float32Array(3*ha);U.__normalArray=new Float32Array(3*ha);U.__webglVertexCount=ha;c(U,Z);k.verticesNeedUpdate=!0;k.colorsNeedUpdate=!0;k.normalsNeedUpdate=!0}}else if(b instanceof THREE.Line){if(!k.__webglVertexBuffer){var aa=k;aa.__webglVertexBuffer=j.createBuffer();aa.__webglColorBuffer=j.createBuffer();aa.__webglLineDistanceBuffer=j.createBuffer();L.info.memory.geometries++;var X=k,ca=b,fa=X.vertices.length;X.__vertexArray=
new Float32Array(3*fa);X.__colorArray=new Float32Array(3*fa);X.__lineDistanceArray=new Float32Array(1*fa);X.__webglLineCount=fa;c(X,ca);k.verticesNeedUpdate=!0;k.colorsNeedUpdate=!0;k.lineDistancesNeedUpdate=!0}}else if(b instanceof THREE.ParticleSystem&&!k.__webglVertexBuffer){var $a=k;$a.__webglVertexBuffer=j.createBuffer();$a.__webglColorBuffer=j.createBuffer();L.info.memory.geometries++;var ia=k,kb=b,ra=ia.vertices.length;ia.__vertexArray=new Float32Array(3*ra);ia.__colorArray=new Float32Array(3*
ra);ia.__sortArray=[];ia.__webglParticleCount=ra;c(ia,kb);k.verticesNeedUpdate=!0;k.colorsNeedUpdate=!0}if(!b.__webglActive){if(b instanceof THREE.Mesh)if(k=b.geometry,k instanceof THREE.BufferGeometry)r(h.__webglObjects,k,b);else{if(k instanceof THREE.Geometry)for(i in k.geometryGroups)p=k.geometryGroups[i],r(h.__webglObjects,p,b)}else b instanceof THREE.Ribbon||b instanceof THREE.Line||b instanceof THREE.ParticleSystem?(k=b.geometry,r(h.__webglObjects,k,b)):b instanceof THREE.ImmediateRenderObject||
b.immediateRenderCallback?h.__webglObjectsImmediate.push({object:b,opaque:null,transparent:null}):b instanceof THREE.Sprite?h.__webglSprites.push(b):b instanceof THREE.LensFlare&&h.__webglFlares.push(b);b.__webglActive=!0}a.__objectsAdded.splice(0,1)}for(;a.__objectsRemoved.length;){var ja=a.__objectsRemoved[0],La=a;ja instanceof THREE.Mesh||ja instanceof THREE.ParticleSystem||ja instanceof THREE.Ribbon||ja instanceof THREE.Line?z(La.__webglObjects,ja):ja instanceof THREE.Sprite?t(La.__webglSprites,
ja):ja instanceof THREE.LensFlare?t(La.__webglFlares,ja):(ja instanceof THREE.ImmediateRenderObject||ja.immediateRenderCallback)&&z(La.__webglObjectsImmediate,ja);ja.__webglActive=!1;a.__objectsRemoved.splice(0,1)}for(var lb=0,db=a.__webglObjects.length;lb<db;lb++){var ma=a.__webglObjects[lb].object,la=ma.geometry,Ba=void 0,xa=void 0,na=void 0;if(la instanceof THREE.BufferGeometry){var Sa=j.DYNAMIC_DRAW,Wa=!la.dynamic,eb=la.attributes,fb=void 0,Pa=void 0;for(fb in eb)Pa=eb[fb],Pa.needsUpdate&&("index"===
fb?(j.bindBuffer(j.ELEMENT_ARRAY_BUFFER,Pa.buffer),j.bufferData(j.ELEMENT_ARRAY_BUFFER,Pa.array,Sa)):(j.bindBuffer(j.ARRAY_BUFFER,Pa.buffer),j.bufferData(j.ARRAY_BUFFER,Pa.array,Sa)),Pa.needsUpdate=!1),Wa&&!Pa.dynamic&&delete Pa.array}else if(ma instanceof THREE.Mesh){for(var jb=0,ob=la.geometryGroupsList.length;jb<ob;jb++)if(Ba=la.geometryGroupsList[jb],na=e(ma,Ba),la.buffersNeedUpdate&&d(Ba,ma),xa=na.attributes&&n(na),la.verticesNeedUpdate||la.morphTargetsNeedUpdate||la.elementsNeedUpdate||la.uvsNeedUpdate||
la.normalsNeedUpdate||la.colorsNeedUpdate||la.tangentsNeedUpdate||xa){var sa=Ba,pb=ma,Ga=j.DYNAMIC_DRAW,Hb=!la.dynamic,mb=na;if(sa.__inittedArrays){var Gb=f(mb),yb=mb.vertexColors?mb.vertexColors:!1,Ib=g(mb),xb=Gb===THREE.SmoothShading,C=void 0,T=void 0,pc=void 0,O=void 0,vb=void 0,qc=void 0,Pb=void 0,Mb=void 0,jc=void 0,wb=void 0,zb=void 0,P=void 0,Q=void 0,R=void 0,qa=void 0,Qb=void 0,Rb=void 0,Sb=void 0,Nb=void 0,Tb=void 0,Ub=void 0,Vb=void 0,Ob=void 0,Wb=void 0,Xb=void 0,Yb=void 0,Kc=void 0,Zb=
void 0,$b=void 0,ac=void 0,Lc=void 0,bc=void 0,cc=void 0,dc=void 0,Mc=void 0,ya=void 0,Bc=void 0,rc=void 0,Ec=void 0,Fc=void 0,Xa=void 0,Cc=void 0,Ta=void 0,Ua=void 0,sc=void 0,kc=void 0,Ma=0,Ra=0,lc=0,mc=0,Cb=0,hb=0,Ca=0,nb=0,Na=0,$=0,ka=0,y=0,za=void 0,Ya=sa.__vertexArray,Nc=sa.__uvArray,Oc=sa.__uv2Array,Db=sa.__normalArray,Ha=sa.__tangentArray,Za=sa.__colorArray,Ia=sa.__skinIndexArray,Ja=sa.__skinWeightArray,rd=sa.__morphTargetsArrays,sd=sa.__morphNormalsArrays,td=sa.__webglCustomAttributesList,
v=void 0,ec=sa.__faceArray,ub=sa.__lineArray,qb=pb.geometry,Wc=qb.elementsNeedUpdate,Jc=qb.uvsNeedUpdate,Xc=qb.normalsNeedUpdate,Yc=qb.tangentsNeedUpdate,Zc=qb.colorsNeedUpdate,pd=qb.morphTargetsNeedUpdate,xc=qb.vertices,ua=sa.faces3,va=sa.faces4,ib=qb.faces,ud=qb.faceVertexUvs[0],vd=qb.faceVertexUvs[1],yc=qb.skinIndices,tc=qb.skinWeights,uc=qb.morphTargets,$c=qb.morphNormals;if(qb.verticesNeedUpdate){C=0;for(T=ua.length;C<T;C++)O=ib[ua[C]],P=xc[O.a],Q=xc[O.b],R=xc[O.c],Ya[Ra]=P.x,Ya[Ra+1]=P.y,Ya[Ra+
2]=P.z,Ya[Ra+3]=Q.x,Ya[Ra+4]=Q.y,Ya[Ra+5]=Q.z,Ya[Ra+6]=R.x,Ya[Ra+7]=R.y,Ya[Ra+8]=R.z,Ra+=9;C=0;for(T=va.length;C<T;C++)O=ib[va[C]],P=xc[O.a],Q=xc[O.b],R=xc[O.c],qa=xc[O.d],Ya[Ra]=P.x,Ya[Ra+1]=P.y,Ya[Ra+2]=P.z,Ya[Ra+3]=Q.x,Ya[Ra+4]=Q.y,Ya[Ra+5]=Q.z,Ya[Ra+6]=R.x,Ya[Ra+7]=R.y,Ya[Ra+8]=R.z,Ya[Ra+9]=qa.x,Ya[Ra+10]=qa.y,Ya[Ra+11]=qa.z,Ra+=12;j.bindBuffer(j.ARRAY_BUFFER,sa.__webglVertexBuffer);j.bufferData(j.ARRAY_BUFFER,Ya,Ga)}if(pd){Xa=0;for(Cc=uc.length;Xa<Cc;Xa++){C=ka=0;for(T=ua.length;C<T;C++)sc=ua[C],
O=ib[sc],P=uc[Xa].vertices[O.a],Q=uc[Xa].vertices[O.b],R=uc[Xa].vertices[O.c],Ta=rd[Xa],Ta[ka]=P.x,Ta[ka+1]=P.y,Ta[ka+2]=P.z,Ta[ka+3]=Q.x,Ta[ka+4]=Q.y,Ta[ka+5]=Q.z,Ta[ka+6]=R.x,Ta[ka+7]=R.y,Ta[ka+8]=R.z,mb.morphNormals&&(xb?(kc=$c[Xa].vertexNormals[sc],Tb=kc.a,Ub=kc.b,Vb=kc.c):Vb=Ub=Tb=$c[Xa].faceNormals[sc],Ua=sd[Xa],Ua[ka]=Tb.x,Ua[ka+1]=Tb.y,Ua[ka+2]=Tb.z,Ua[ka+3]=Ub.x,Ua[ka+4]=Ub.y,Ua[ka+5]=Ub.z,Ua[ka+6]=Vb.x,Ua[ka+7]=Vb.y,Ua[ka+8]=Vb.z),ka+=9;C=0;for(T=va.length;C<T;C++)sc=va[C],O=ib[sc],P=uc[Xa].vertices[O.a],
Q=uc[Xa].vertices[O.b],R=uc[Xa].vertices[O.c],qa=uc[Xa].vertices[O.d],Ta=rd[Xa],Ta[ka]=P.x,Ta[ka+1]=P.y,Ta[ka+2]=P.z,Ta[ka+3]=Q.x,Ta[ka+4]=Q.y,Ta[ka+5]=Q.z,Ta[ka+6]=R.x,Ta[ka+7]=R.y,Ta[ka+8]=R.z,Ta[ka+9]=qa.x,Ta[ka+10]=qa.y,Ta[ka+11]=qa.z,mb.morphNormals&&(xb?(kc=$c[Xa].vertexNormals[sc],Tb=kc.a,Ub=kc.b,Vb=kc.c,Ob=kc.d):Ob=Vb=Ub=Tb=$c[Xa].faceNormals[sc],Ua=sd[Xa],Ua[ka]=Tb.x,Ua[ka+1]=Tb.y,Ua[ka+2]=Tb.z,Ua[ka+3]=Ub.x,Ua[ka+4]=Ub.y,Ua[ka+5]=Ub.z,Ua[ka+6]=Vb.x,Ua[ka+7]=Vb.y,Ua[ka+8]=Vb.z,Ua[ka+9]=Ob.x,
Ua[ka+10]=Ob.y,Ua[ka+11]=Ob.z),ka+=12;j.bindBuffer(j.ARRAY_BUFFER,sa.__webglMorphTargetsBuffers[Xa]);j.bufferData(j.ARRAY_BUFFER,rd[Xa],Ga);mb.morphNormals&&(j.bindBuffer(j.ARRAY_BUFFER,sa.__webglMorphNormalsBuffers[Xa]),j.bufferData(j.ARRAY_BUFFER,sd[Xa],Ga))}}if(tc.length){C=0;for(T=ua.length;C<T;C++)O=ib[ua[C]],Zb=tc[O.a],$b=tc[O.b],ac=tc[O.c],Ja[$]=Zb.x,Ja[$+1]=Zb.y,Ja[$+2]=Zb.z,Ja[$+3]=Zb.w,Ja[$+4]=$b.x,Ja[$+5]=$b.y,Ja[$+6]=$b.z,Ja[$+7]=$b.w,Ja[$+8]=ac.x,Ja[$+9]=ac.y,Ja[$+10]=ac.z,Ja[$+11]=ac.w,
bc=yc[O.a],cc=yc[O.b],dc=yc[O.c],Ia[$]=bc.x,Ia[$+1]=bc.y,Ia[$+2]=bc.z,Ia[$+3]=bc.w,Ia[$+4]=cc.x,Ia[$+5]=cc.y,Ia[$+6]=cc.z,Ia[$+7]=cc.w,Ia[$+8]=dc.x,Ia[$+9]=dc.y,Ia[$+10]=dc.z,Ia[$+11]=dc.w,$+=12;C=0;for(T=va.length;C<T;C++)O=ib[va[C]],Zb=tc[O.a],$b=tc[O.b],ac=tc[O.c],Lc=tc[O.d],Ja[$]=Zb.x,Ja[$+1]=Zb.y,Ja[$+2]=Zb.z,Ja[$+3]=Zb.w,Ja[$+4]=$b.x,Ja[$+5]=$b.y,Ja[$+6]=$b.z,Ja[$+7]=$b.w,Ja[$+8]=ac.x,Ja[$+9]=ac.y,Ja[$+10]=ac.z,Ja[$+11]=ac.w,Ja[$+12]=Lc.x,Ja[$+13]=Lc.y,Ja[$+14]=Lc.z,Ja[$+15]=Lc.w,bc=yc[O.a],
cc=yc[O.b],dc=yc[O.c],Mc=yc[O.d],Ia[$]=bc.x,Ia[$+1]=bc.y,Ia[$+2]=bc.z,Ia[$+3]=bc.w,Ia[$+4]=cc.x,Ia[$+5]=cc.y,Ia[$+6]=cc.z,Ia[$+7]=cc.w,Ia[$+8]=dc.x,Ia[$+9]=dc.y,Ia[$+10]=dc.z,Ia[$+11]=dc.w,Ia[$+12]=Mc.x,Ia[$+13]=Mc.y,Ia[$+14]=Mc.z,Ia[$+15]=Mc.w,$+=16;0<$&&(j.bindBuffer(j.ARRAY_BUFFER,sa.__webglSkinIndicesBuffer),j.bufferData(j.ARRAY_BUFFER,Ia,Ga),j.bindBuffer(j.ARRAY_BUFFER,sa.__webglSkinWeightsBuffer),j.bufferData(j.ARRAY_BUFFER,Ja,Ga))}if(Zc&&yb){C=0;for(T=ua.length;C<T;C++)O=ib[ua[C]],Pb=O.vertexColors,
Mb=O.color,3===Pb.length&&yb===THREE.VertexColors?(Wb=Pb[0],Xb=Pb[1],Yb=Pb[2]):Yb=Xb=Wb=Mb,Za[Na]=Wb.r,Za[Na+1]=Wb.g,Za[Na+2]=Wb.b,Za[Na+3]=Xb.r,Za[Na+4]=Xb.g,Za[Na+5]=Xb.b,Za[Na+6]=Yb.r,Za[Na+7]=Yb.g,Za[Na+8]=Yb.b,Na+=9;C=0;for(T=va.length;C<T;C++)O=ib[va[C]],Pb=O.vertexColors,Mb=O.color,4===Pb.length&&yb===THREE.VertexColors?(Wb=Pb[0],Xb=Pb[1],Yb=Pb[2],Kc=Pb[3]):Kc=Yb=Xb=Wb=Mb,Za[Na]=Wb.r,Za[Na+1]=Wb.g,Za[Na+2]=Wb.b,Za[Na+3]=Xb.r,Za[Na+4]=Xb.g,Za[Na+5]=Xb.b,Za[Na+6]=Yb.r,Za[Na+7]=Yb.g,Za[Na+8]=
Yb.b,Za[Na+9]=Kc.r,Za[Na+10]=Kc.g,Za[Na+11]=Kc.b,Na+=12;0<Na&&(j.bindBuffer(j.ARRAY_BUFFER,sa.__webglColorBuffer),j.bufferData(j.ARRAY_BUFFER,Za,Ga))}if(Yc&&qb.hasTangents){C=0;for(T=ua.length;C<T;C++)O=ib[ua[C]],jc=O.vertexTangents,Qb=jc[0],Rb=jc[1],Sb=jc[2],Ha[Ca]=Qb.x,Ha[Ca+1]=Qb.y,Ha[Ca+2]=Qb.z,Ha[Ca+3]=Qb.w,Ha[Ca+4]=Rb.x,Ha[Ca+5]=Rb.y,Ha[Ca+6]=Rb.z,Ha[Ca+7]=Rb.w,Ha[Ca+8]=Sb.x,Ha[Ca+9]=Sb.y,Ha[Ca+10]=Sb.z,Ha[Ca+11]=Sb.w,Ca+=12;C=0;for(T=va.length;C<T;C++)O=ib[va[C]],jc=O.vertexTangents,Qb=jc[0],
Rb=jc[1],Sb=jc[2],Nb=jc[3],Ha[Ca]=Qb.x,Ha[Ca+1]=Qb.y,Ha[Ca+2]=Qb.z,Ha[Ca+3]=Qb.w,Ha[Ca+4]=Rb.x,Ha[Ca+5]=Rb.y,Ha[Ca+6]=Rb.z,Ha[Ca+7]=Rb.w,Ha[Ca+8]=Sb.x,Ha[Ca+9]=Sb.y,Ha[Ca+10]=Sb.z,Ha[Ca+11]=Sb.w,Ha[Ca+12]=Nb.x,Ha[Ca+13]=Nb.y,Ha[Ca+14]=Nb.z,Ha[Ca+15]=Nb.w,Ca+=16;j.bindBuffer(j.ARRAY_BUFFER,sa.__webglTangentBuffer);j.bufferData(j.ARRAY_BUFFER,Ha,Ga)}if(Xc&&Gb){C=0;for(T=ua.length;C<T;C++)if(O=ib[ua[C]],vb=O.vertexNormals,qc=O.normal,3===vb.length&&xb)for(ya=0;3>ya;ya++)rc=vb[ya],Db[hb]=rc.x,Db[hb+1]=
rc.y,Db[hb+2]=rc.z,hb+=3;else for(ya=0;3>ya;ya++)Db[hb]=qc.x,Db[hb+1]=qc.y,Db[hb+2]=qc.z,hb+=3;C=0;for(T=va.length;C<T;C++)if(O=ib[va[C]],vb=O.vertexNormals,qc=O.normal,4===vb.length&&xb)for(ya=0;4>ya;ya++)rc=vb[ya],Db[hb]=rc.x,Db[hb+1]=rc.y,Db[hb+2]=rc.z,hb+=3;else for(ya=0;4>ya;ya++)Db[hb]=qc.x,Db[hb+1]=qc.y,Db[hb+2]=qc.z,hb+=3;j.bindBuffer(j.ARRAY_BUFFER,sa.__webglNormalBuffer);j.bufferData(j.ARRAY_BUFFER,Db,Ga)}if(Jc&&ud&&Ib){C=0;for(T=ua.length;C<T;C++)if(pc=ua[C],wb=ud[pc],void 0!==wb)for(ya=
0;3>ya;ya++)Ec=wb[ya],Nc[lc]=Ec.x,Nc[lc+1]=Ec.y,lc+=2;C=0;for(T=va.length;C<T;C++)if(pc=va[C],wb=ud[pc],void 0!==wb)for(ya=0;4>ya;ya++)Ec=wb[ya],Nc[lc]=Ec.x,Nc[lc+1]=Ec.y,lc+=2;0<lc&&(j.bindBuffer(j.ARRAY_BUFFER,sa.__webglUVBuffer),j.bufferData(j.ARRAY_BUFFER,Nc,Ga))}if(Jc&&vd&&Ib){C=0;for(T=ua.length;C<T;C++)if(pc=ua[C],zb=vd[pc],void 0!==zb)for(ya=0;3>ya;ya++)Fc=zb[ya],Oc[mc]=Fc.x,Oc[mc+1]=Fc.y,mc+=2;C=0;for(T=va.length;C<T;C++)if(pc=va[C],zb=vd[pc],void 0!==zb)for(ya=0;4>ya;ya++)Fc=zb[ya],Oc[mc]=
Fc.x,Oc[mc+1]=Fc.y,mc+=2;0<mc&&(j.bindBuffer(j.ARRAY_BUFFER,sa.__webglUV2Buffer),j.bufferData(j.ARRAY_BUFFER,Oc,Ga))}if(Wc){C=0;for(T=ua.length;C<T;C++)ec[Cb]=Ma,ec[Cb+1]=Ma+1,ec[Cb+2]=Ma+2,Cb+=3,ub[nb]=Ma,ub[nb+1]=Ma+1,ub[nb+2]=Ma,ub[nb+3]=Ma+2,ub[nb+4]=Ma+1,ub[nb+5]=Ma+2,nb+=6,Ma+=3;C=0;for(T=va.length;C<T;C++)ec[Cb]=Ma,ec[Cb+1]=Ma+1,ec[Cb+2]=Ma+3,ec[Cb+3]=Ma+1,ec[Cb+4]=Ma+2,ec[Cb+5]=Ma+3,Cb+=6,ub[nb]=Ma,ub[nb+1]=Ma+1,ub[nb+2]=Ma,ub[nb+3]=Ma+3,ub[nb+4]=Ma+1,ub[nb+5]=Ma+2,ub[nb+6]=Ma+2,ub[nb+7]=
Ma+3,nb+=8,Ma+=4;j.bindBuffer(j.ELEMENT_ARRAY_BUFFER,sa.__webglFaceBuffer);j.bufferData(j.ELEMENT_ARRAY_BUFFER,ec,Ga);j.bindBuffer(j.ELEMENT_ARRAY_BUFFER,sa.__webglLineBuffer);j.bufferData(j.ELEMENT_ARRAY_BUFFER,ub,Ga)}if(td){ya=0;for(Bc=td.length;ya<Bc;ya++)if(v=td[ya],v.__original.needsUpdate){y=0;if(1===v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){C=0;for(T=ua.length;C<T;C++)O=ib[ua[C]],v.array[y]=v.value[O.a],v.array[y+1]=v.value[O.b],v.array[y+2]=v.value[O.c],y+=3;C=0;for(T=va.length;C<
T;C++)O=ib[va[C]],v.array[y]=v.value[O.a],v.array[y+1]=v.value[O.b],v.array[y+2]=v.value[O.c],v.array[y+3]=v.value[O.d],y+=4}else{if("faces"===v.boundTo){C=0;for(T=ua.length;C<T;C++)za=v.value[ua[C]],v.array[y]=za,v.array[y+1]=za,v.array[y+2]=za,y+=3;C=0;for(T=va.length;C<T;C++)za=v.value[va[C]],v.array[y]=za,v.array[y+1]=za,v.array[y+2]=za,v.array[y+3]=za,y+=4}}else if(2===v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){C=0;for(T=ua.length;C<T;C++)O=ib[ua[C]],P=v.value[O.a],Q=v.value[O.b],
R=v.value[O.c],v.array[y]=P.x,v.array[y+1]=P.y,v.array[y+2]=Q.x,v.array[y+3]=Q.y,v.array[y+4]=R.x,v.array[y+5]=R.y,y+=6;C=0;for(T=va.length;C<T;C++)O=ib[va[C]],P=v.value[O.a],Q=v.value[O.b],R=v.value[O.c],qa=v.value[O.d],v.array[y]=P.x,v.array[y+1]=P.y,v.array[y+2]=Q.x,v.array[y+3]=Q.y,v.array[y+4]=R.x,v.array[y+5]=R.y,v.array[y+6]=qa.x,v.array[y+7]=qa.y,y+=8}else{if("faces"===v.boundTo){C=0;for(T=ua.length;C<T;C++)R=Q=P=za=v.value[ua[C]],v.array[y]=P.x,v.array[y+1]=P.y,v.array[y+2]=Q.x,v.array[y+
3]=Q.y,v.array[y+4]=R.x,v.array[y+5]=R.y,y+=6;C=0;for(T=va.length;C<T;C++)qa=R=Q=P=za=v.value[va[C]],v.array[y]=P.x,v.array[y+1]=P.y,v.array[y+2]=Q.x,v.array[y+3]=Q.y,v.array[y+4]=R.x,v.array[y+5]=R.y,v.array[y+6]=qa.x,v.array[y+7]=qa.y,y+=8}}else if(3===v.size){var Y;Y="c"===v.type?["r","g","b"]:["x","y","z"];if(void 0===v.boundTo||"vertices"===v.boundTo){C=0;for(T=ua.length;C<T;C++)O=ib[ua[C]],P=v.value[O.a],Q=v.value[O.b],R=v.value[O.c],v.array[y]=P[Y[0]],v.array[y+1]=P[Y[1]],v.array[y+2]=P[Y[2]],
v.array[y+3]=Q[Y[0]],v.array[y+4]=Q[Y[1]],v.array[y+5]=Q[Y[2]],v.array[y+6]=R[Y[0]],v.array[y+7]=R[Y[1]],v.array[y+8]=R[Y[2]],y+=9;C=0;for(T=va.length;C<T;C++)O=ib[va[C]],P=v.value[O.a],Q=v.value[O.b],R=v.value[O.c],qa=v.value[O.d],v.array[y]=P[Y[0]],v.array[y+1]=P[Y[1]],v.array[y+2]=P[Y[2]],v.array[y+3]=Q[Y[0]],v.array[y+4]=Q[Y[1]],v.array[y+5]=Q[Y[2]],v.array[y+6]=R[Y[0]],v.array[y+7]=R[Y[1]],v.array[y+8]=R[Y[2]],v.array[y+9]=qa[Y[0]],v.array[y+10]=qa[Y[1]],v.array[y+11]=qa[Y[2]],y+=12}else if("faces"===
v.boundTo){C=0;for(T=ua.length;C<T;C++)R=Q=P=za=v.value[ua[C]],v.array[y]=P[Y[0]],v.array[y+1]=P[Y[1]],v.array[y+2]=P[Y[2]],v.array[y+3]=Q[Y[0]],v.array[y+4]=Q[Y[1]],v.array[y+5]=Q[Y[2]],v.array[y+6]=R[Y[0]],v.array[y+7]=R[Y[1]],v.array[y+8]=R[Y[2]],y+=9;C=0;for(T=va.length;C<T;C++)qa=R=Q=P=za=v.value[va[C]],v.array[y]=P[Y[0]],v.array[y+1]=P[Y[1]],v.array[y+2]=P[Y[2]],v.array[y+3]=Q[Y[0]],v.array[y+4]=Q[Y[1]],v.array[y+5]=Q[Y[2]],v.array[y+6]=R[Y[0]],v.array[y+7]=R[Y[1]],v.array[y+8]=R[Y[2]],v.array[y+
9]=qa[Y[0]],v.array[y+10]=qa[Y[1]],v.array[y+11]=qa[Y[2]],y+=12}else if("faceVertices"===v.boundTo){C=0;for(T=ua.length;C<T;C++)za=v.value[ua[C]],P=za[0],Q=za[1],R=za[2],v.array[y]=P[Y[0]],v.array[y+1]=P[Y[1]],v.array[y+2]=P[Y[2]],v.array[y+3]=Q[Y[0]],v.array[y+4]=Q[Y[1]],v.array[y+5]=Q[Y[2]],v.array[y+6]=R[Y[0]],v.array[y+7]=R[Y[1]],v.array[y+8]=R[Y[2]],y+=9;C=0;for(T=va.length;C<T;C++)za=v.value[va[C]],P=za[0],Q=za[1],R=za[2],qa=za[3],v.array[y]=P[Y[0]],v.array[y+1]=P[Y[1]],v.array[y+2]=P[Y[2]],
v.array[y+3]=Q[Y[0]],v.array[y+4]=Q[Y[1]],v.array[y+5]=Q[Y[2]],v.array[y+6]=R[Y[0]],v.array[y+7]=R[Y[1]],v.array[y+8]=R[Y[2]],v.array[y+9]=qa[Y[0]],v.array[y+10]=qa[Y[1]],v.array[y+11]=qa[Y[2]],y+=12}}else if(4===v.size)if(void 0===v.boundTo||"vertices"===v.boundTo){C=0;for(T=ua.length;C<T;C++)O=ib[ua[C]],P=v.value[O.a],Q=v.value[O.b],R=v.value[O.c],v.array[y]=P.x,v.array[y+1]=P.y,v.array[y+2]=P.z,v.array[y+3]=P.w,v.array[y+4]=Q.x,v.array[y+5]=Q.y,v.array[y+6]=Q.z,v.array[y+7]=Q.w,v.array[y+8]=R.x,
v.array[y+9]=R.y,v.array[y+10]=R.z,v.array[y+11]=R.w,y+=12;C=0;for(T=va.length;C<T;C++)O=ib[va[C]],P=v.value[O.a],Q=v.value[O.b],R=v.value[O.c],qa=v.value[O.d],v.array[y]=P.x,v.array[y+1]=P.y,v.array[y+2]=P.z,v.array[y+3]=P.w,v.array[y+4]=Q.x,v.array[y+5]=Q.y,v.array[y+6]=Q.z,v.array[y+7]=Q.w,v.array[y+8]=R.x,v.array[y+9]=R.y,v.array[y+10]=R.z,v.array[y+11]=R.w,v.array[y+12]=qa.x,v.array[y+13]=qa.y,v.array[y+14]=qa.z,v.array[y+15]=qa.w,y+=16}else if("faces"===v.boundTo){C=0;for(T=ua.length;C<T;C++)R=
Q=P=za=v.value[ua[C]],v.array[y]=P.x,v.array[y+1]=P.y,v.array[y+2]=P.z,v.array[y+3]=P.w,v.array[y+4]=Q.x,v.array[y+5]=Q.y,v.array[y+6]=Q.z,v.array[y+7]=Q.w,v.array[y+8]=R.x,v.array[y+9]=R.y,v.array[y+10]=R.z,v.array[y+11]=R.w,y+=12;C=0;for(T=va.length;C<T;C++)qa=R=Q=P=za=v.value[va[C]],v.array[y]=P.x,v.array[y+1]=P.y,v.array[y+2]=P.z,v.array[y+3]=P.w,v.array[y+4]=Q.x,v.array[y+5]=Q.y,v.array[y+6]=Q.z,v.array[y+7]=Q.w,v.array[y+8]=R.x,v.array[y+9]=R.y,v.array[y+10]=R.z,v.array[y+11]=R.w,v.array[y+
12]=qa.x,v.array[y+13]=qa.y,v.array[y+14]=qa.z,v.array[y+15]=qa.w,y+=16}else if("faceVertices"===v.boundTo){C=0;for(T=ua.length;C<T;C++)za=v.value[ua[C]],P=za[0],Q=za[1],R=za[2],v.array[y]=P.x,v.array[y+1]=P.y,v.array[y+2]=P.z,v.array[y+3]=P.w,v.array[y+4]=Q.x,v.array[y+5]=Q.y,v.array[y+6]=Q.z,v.array[y+7]=Q.w,v.array[y+8]=R.x,v.array[y+9]=R.y,v.array[y+10]=R.z,v.array[y+11]=R.w,y+=12;C=0;for(T=va.length;C<T;C++)za=v.value[va[C]],P=za[0],Q=za[1],R=za[2],qa=za[3],v.array[y]=P.x,v.array[y+1]=P.y,v.array[y+
2]=P.z,v.array[y+3]=P.w,v.array[y+4]=Q.x,v.array[y+5]=Q.y,v.array[y+6]=Q.z,v.array[y+7]=Q.w,v.array[y+8]=R.x,v.array[y+9]=R.y,v.array[y+10]=R.z,v.array[y+11]=R.w,v.array[y+12]=qa.x,v.array[y+13]=qa.y,v.array[y+14]=qa.z,v.array[y+15]=qa.w,y+=16}j.bindBuffer(j.ARRAY_BUFFER,v.buffer);j.bufferData(j.ARRAY_BUFFER,v.array,Ga)}}Hb&&(delete sa.__inittedArrays,delete sa.__colorArray,delete sa.__normalArray,delete sa.__tangentArray,delete sa.__uvArray,delete sa.__uv2Array,delete sa.__faceArray,delete sa.__vertexArray,
delete sa.__lineArray,delete sa.__skinIndexArray,delete sa.__skinWeightArray)}}la.verticesNeedUpdate=!1;la.morphTargetsNeedUpdate=!1;la.elementsNeedUpdate=!1;la.uvsNeedUpdate=!1;la.normalsNeedUpdate=!1;la.colorsNeedUpdate=!1;la.tangentsNeedUpdate=!1;la.buffersNeedUpdate=!1;na.attributes&&q(na)}else if(ma instanceof THREE.Ribbon){na=e(ma,la);xa=na.attributes&&n(na);if(la.verticesNeedUpdate||la.colorsNeedUpdate||la.normalsNeedUpdate||xa){var Eb=la,ad=j.DYNAMIC_DRAW,Pc=void 0,Qc=void 0,Rc=void 0,bd=
void 0,Aa=void 0,cd=void 0,dd=void 0,ed=void 0,Cd=void 0,bb=void 0,Gc=void 0,Ea=void 0,rb=void 0,Dd=Eb.vertices,Ed=Eb.colors,Fd=Eb.normals,Od=Dd.length,Pd=Ed.length,Qd=Fd.length,fd=Eb.__vertexArray,gd=Eb.__colorArray,hd=Eb.__normalArray,Rd=Eb.colorsNeedUpdate,Sd=Eb.normalsNeedUpdate,wd=Eb.__webglCustomAttributesList;if(Eb.verticesNeedUpdate){for(Pc=0;Pc<Od;Pc++)bd=Dd[Pc],Aa=3*Pc,fd[Aa]=bd.x,fd[Aa+1]=bd.y,fd[Aa+2]=bd.z;j.bindBuffer(j.ARRAY_BUFFER,Eb.__webglVertexBuffer);j.bufferData(j.ARRAY_BUFFER,
fd,ad)}if(Rd){for(Qc=0;Qc<Pd;Qc++)cd=Ed[Qc],Aa=3*Qc,gd[Aa]=cd.r,gd[Aa+1]=cd.g,gd[Aa+2]=cd.b;j.bindBuffer(j.ARRAY_BUFFER,Eb.__webglColorBuffer);j.bufferData(j.ARRAY_BUFFER,gd,ad)}if(Sd){for(Rc=0;Rc<Qd;Rc++)dd=Fd[Rc],Aa=3*Rc,hd[Aa]=dd.x,hd[Aa+1]=dd.y,hd[Aa+2]=dd.z;j.bindBuffer(j.ARRAY_BUFFER,Eb.__webglNormalBuffer);j.bufferData(j.ARRAY_BUFFER,hd,ad)}if(wd){ed=0;for(Cd=wd.length;ed<Cd;ed++)if(Ea=wd[ed],Ea.needsUpdate&&(void 0===Ea.boundTo||"vertices"===Ea.boundTo)){Aa=0;Gc=Ea.value.length;if(1===Ea.size)for(bb=
0;bb<Gc;bb++)Ea.array[bb]=Ea.value[bb];else if(2===Ea.size)for(bb=0;bb<Gc;bb++)rb=Ea.value[bb],Ea.array[Aa]=rb.x,Ea.array[Aa+1]=rb.y,Aa+=2;else if(3===Ea.size)if("c"===Ea.type)for(bb=0;bb<Gc;bb++)rb=Ea.value[bb],Ea.array[Aa]=rb.r,Ea.array[Aa+1]=rb.g,Ea.array[Aa+2]=rb.b,Aa+=3;else for(bb=0;bb<Gc;bb++)rb=Ea.value[bb],Ea.array[Aa]=rb.x,Ea.array[Aa+1]=rb.y,Ea.array[Aa+2]=rb.z,Aa+=3;else if(4===Ea.size)for(bb=0;bb<Gc;bb++)rb=Ea.value[bb],Ea.array[Aa]=rb.x,Ea.array[Aa+1]=rb.y,Ea.array[Aa+2]=rb.z,Ea.array[Aa+
3]=rb.w,Aa+=4;j.bindBuffer(j.ARRAY_BUFFER,Ea.buffer);j.bufferData(j.ARRAY_BUFFER,Ea.array,ad)}}}la.verticesNeedUpdate=!1;la.colorsNeedUpdate=!1;la.normalsNeedUpdate=!1;na.attributes&&q(na)}else if(ma instanceof THREE.Line){na=e(ma,la);xa=na.attributes&&n(na);if(la.verticesNeedUpdate||la.colorsNeedUpdate||la.lineDistancesNeedUpdate||xa){var Fb=la,id=j.DYNAMIC_DRAW,Sc=void 0,Tc=void 0,Uc=void 0,jd=void 0,Ka=void 0,kd=void 0,Gd=Fb.vertices,Hd=Fb.colors,Id=Fb.lineDistances,Td=Gd.length,Ud=Hd.length,Vd=
Id.length,ld=Fb.__vertexArray,md=Fb.__colorArray,Jd=Fb.__lineDistanceArray,Wd=Fb.colorsNeedUpdate,Xd=Fb.lineDistancesNeedUpdate,xd=Fb.__webglCustomAttributesList,nd=void 0,Kd=void 0,cb=void 0,Hc=void 0,sb=void 0,Fa=void 0;if(Fb.verticesNeedUpdate){for(Sc=0;Sc<Td;Sc++)jd=Gd[Sc],Ka=3*Sc,ld[Ka]=jd.x,ld[Ka+1]=jd.y,ld[Ka+2]=jd.z;j.bindBuffer(j.ARRAY_BUFFER,Fb.__webglVertexBuffer);j.bufferData(j.ARRAY_BUFFER,ld,id)}if(Wd){for(Tc=0;Tc<Ud;Tc++)kd=Hd[Tc],Ka=3*Tc,md[Ka]=kd.r,md[Ka+1]=kd.g,md[Ka+2]=kd.b;j.bindBuffer(j.ARRAY_BUFFER,
Fb.__webglColorBuffer);j.bufferData(j.ARRAY_BUFFER,md,id)}if(Xd){for(Uc=0;Uc<Vd;Uc++)Jd[Uc]=Id[Uc];j.bindBuffer(j.ARRAY_BUFFER,Fb.__webglLineDistanceBuffer);j.bufferData(j.ARRAY_BUFFER,Jd,id)}if(xd){nd=0;for(Kd=xd.length;nd<Kd;nd++)if(Fa=xd[nd],Fa.needsUpdate&&(void 0===Fa.boundTo||"vertices"===Fa.boundTo)){Ka=0;Hc=Fa.value.length;if(1===Fa.size)for(cb=0;cb<Hc;cb++)Fa.array[cb]=Fa.value[cb];else if(2===Fa.size)for(cb=0;cb<Hc;cb++)sb=Fa.value[cb],Fa.array[Ka]=sb.x,Fa.array[Ka+1]=sb.y,Ka+=2;else if(3===
Fa.size)if("c"===Fa.type)for(cb=0;cb<Hc;cb++)sb=Fa.value[cb],Fa.array[Ka]=sb.r,Fa.array[Ka+1]=sb.g,Fa.array[Ka+2]=sb.b,Ka+=3;else for(cb=0;cb<Hc;cb++)sb=Fa.value[cb],Fa.array[Ka]=sb.x,Fa.array[Ka+1]=sb.y,Fa.array[Ka+2]=sb.z,Ka+=3;else if(4===Fa.size)for(cb=0;cb<Hc;cb++)sb=Fa.value[cb],Fa.array[Ka]=sb.x,Fa.array[Ka+1]=sb.y,Fa.array[Ka+2]=sb.z,Fa.array[Ka+3]=sb.w,Ka+=4;j.bindBuffer(j.ARRAY_BUFFER,Fa.buffer);j.bufferData(j.ARRAY_BUFFER,Fa.array,id)}}}la.verticesNeedUpdate=!1;la.colorsNeedUpdate=!1;la.lineDistancesNeedUpdate=
!1;na.attributes&&q(na)}else if(ma instanceof THREE.ParticleSystem){na=e(ma,la);xa=na.attributes&&n(na);if(la.verticesNeedUpdate||la.colorsNeedUpdate||ma.sortParticles||xa){var fc=la,yd=j.DYNAMIC_DRAW,Vc=ma,tb=void 0,gc=void 0,hc=void 0,da=void 0,ic=void 0,vc=void 0,od=fc.vertices,zd=od.length,Ad=fc.colors,Ld=Ad.length,zc=fc.__vertexArray,Ac=fc.__colorArray,nc=fc.__sortArray,Md=fc.verticesNeedUpdate,Nd=fc.colorsNeedUpdate,oc=fc.__webglCustomAttributesList,Kb=void 0,Ic=void 0,pa=void 0,Lb=void 0,Da=
void 0,ba=void 0;if(Vc.sortParticles){Va.copy(Qa);Va.multiply(Vc.matrixWorld);for(tb=0;tb<zd;tb++)hc=od[tb],wa.copy(hc),wa.applyProjection(Va),nc[tb]=[wa.z,tb];nc.sort(l);for(tb=0;tb<zd;tb++)hc=od[nc[tb][1]],da=3*tb,zc[da]=hc.x,zc[da+1]=hc.y,zc[da+2]=hc.z;for(gc=0;gc<Ld;gc++)da=3*gc,vc=Ad[nc[gc][1]],Ac[da]=vc.r,Ac[da+1]=vc.g,Ac[da+2]=vc.b;if(oc){Kb=0;for(Ic=oc.length;Kb<Ic;Kb++)if(ba=oc[Kb],void 0===ba.boundTo||"vertices"===ba.boundTo)if(da=0,Lb=ba.value.length,1===ba.size)for(pa=0;pa<Lb;pa++)ic=
nc[pa][1],ba.array[pa]=ba.value[ic];else if(2===ba.size)for(pa=0;pa<Lb;pa++)ic=nc[pa][1],Da=ba.value[ic],ba.array[da]=Da.x,ba.array[da+1]=Da.y,da+=2;else if(3===ba.size)if("c"===ba.type)for(pa=0;pa<Lb;pa++)ic=nc[pa][1],Da=ba.value[ic],ba.array[da]=Da.r,ba.array[da+1]=Da.g,ba.array[da+2]=Da.b,da+=3;else for(pa=0;pa<Lb;pa++)ic=nc[pa][1],Da=ba.value[ic],ba.array[da]=Da.x,ba.array[da+1]=Da.y,ba.array[da+2]=Da.z,da+=3;else if(4===ba.size)for(pa=0;pa<Lb;pa++)ic=nc[pa][1],Da=ba.value[ic],ba.array[da]=Da.x,
ba.array[da+1]=Da.y,ba.array[da+2]=Da.z,ba.array[da+3]=Da.w,da+=4}}else{if(Md)for(tb=0;tb<zd;tb++)hc=od[tb],da=3*tb,zc[da]=hc.x,zc[da+1]=hc.y,zc[da+2]=hc.z;if(Nd)for(gc=0;gc<Ld;gc++)vc=Ad[gc],da=3*gc,Ac[da]=vc.r,Ac[da+1]=vc.g,Ac[da+2]=vc.b;if(oc){Kb=0;for(Ic=oc.length;Kb<Ic;Kb++)if(ba=oc[Kb],ba.needsUpdate&&(void 0===ba.boundTo||"vertices"===ba.boundTo))if(Lb=ba.value.length,da=0,1===ba.size)for(pa=0;pa<Lb;pa++)ba.array[pa]=ba.value[pa];else if(2===ba.size)for(pa=0;pa<Lb;pa++)Da=ba.value[pa],ba.array[da]=
Da.x,ba.array[da+1]=Da.y,da+=2;else if(3===ba.size)if("c"===ba.type)for(pa=0;pa<Lb;pa++)Da=ba.value[pa],ba.array[da]=Da.r,ba.array[da+1]=Da.g,ba.array[da+2]=Da.b,da+=3;else for(pa=0;pa<Lb;pa++)Da=ba.value[pa],ba.array[da]=Da.x,ba.array[da+1]=Da.y,ba.array[da+2]=Da.z,da+=3;else if(4===ba.size)for(pa=0;pa<Lb;pa++)Da=ba.value[pa],ba.array[da]=Da.x,ba.array[da+1]=Da.y,ba.array[da+2]=Da.z,ba.array[da+3]=Da.w,da+=4}}if(Md||Vc.sortParticles)j.bindBuffer(j.ARRAY_BUFFER,fc.__webglVertexBuffer),j.bufferData(j.ARRAY_BUFFER,
zc,yd);if(Nd||Vc.sortParticles)j.bindBuffer(j.ARRAY_BUFFER,fc.__webglColorBuffer),j.bufferData(j.ARRAY_BUFFER,Ac,yd);if(oc){Kb=0;for(Ic=oc.length;Kb<Ic;Kb++)if(ba=oc[Kb],ba.needsUpdate||Vc.sortParticles)j.bindBuffer(j.ARRAY_BUFFER,ba.buffer),j.bufferData(j.ARRAY_BUFFER,ba.array,yd)}}la.verticesNeedUpdate=!1;la.colorsNeedUpdate=!1;na.attributes&&q(na)}}};this.initMaterial=function(a,b,c,d){var e,f,g,h;a.addEventListener("dispose",Xc);var i,k,l,m,p;a instanceof THREE.MeshDepthMaterial?p="depth":a instanceof
THREE.MeshNormalMaterial?p="normal":a instanceof THREE.MeshBasicMaterial?p="basic":a instanceof THREE.MeshLambertMaterial?p="lambert":a instanceof THREE.MeshPhongMaterial?p="phong":a instanceof THREE.LineBasicMaterial?p="basic":a instanceof THREE.LineDashedMaterial?p="dashed":a instanceof THREE.ParticleBasicMaterial&&(p="particle_basic");if(p){var n=THREE.ShaderLib[p];a.uniforms=THREE.UniformsUtils.clone(n.uniforms);a.vertexShader=n.vertexShader;a.fragmentShader=n.fragmentShader}var q,s,r;e=g=s=r=
n=0;for(f=b.length;e<f;e++)q=b[e],q.onlyShadow||(q instanceof THREE.DirectionalLight&&g++,q instanceof THREE.PointLight&&s++,q instanceof THREE.SpotLight&&r++,q instanceof THREE.HemisphereLight&&n++);e=g;f=s;g=r;h=n;n=q=0;for(r=b.length;n<r;n++)s=b[n],s.castShadow&&(s instanceof THREE.SpotLight&&q++,s instanceof THREE.DirectionalLight&&!s.shadowCascade&&q++);m=q;Cc&&d&&d.useVertexTexture?l=1024:(b=j.getParameter(j.MAX_VERTEX_UNIFORM_VECTORS),b=Math.floor((b-20)/4),void 0!==d&&d instanceof THREE.SkinnedMesh&&
...
j.blendEquation(j.FUNC_ADD),j.blendFunc(j.ZERO,j.ONE_MINUS_SRC_COLOR)):a===THREE.MultiplyBlending?(j.enable(j.BLEND),j.blendEquation(j.FUNC_ADD),j.blendFunc(j.ZERO,j.SRC_COLOR)):a===THREE.CustomBlending?j.enable(j.BLEND):(j.enable(j.BLEND),j.blendEquationSeparate(j.FUNC_ADD,j.FUNC_ADD),j.blendFuncSeparate(j.SRC_ALPHA,j.ONE_MINUS_SRC_ALPHA,j.ONE,j.ONE_MINUS_SRC_ALPHA)),Z=a);if(a===THREE.CustomBlending){if(b!==aa&&(j.blendEquation(F(b)),aa=b),c!==ia||d!==ra)j.blendFunc(F(c),F(d)),ia=c,ra=d}else ra=
ia=aa=null};this.setTexture=function(a,b){if(a.needsUpdate){a.__webglInit||(a.__webglInit=!0,a.addEventListener("dispose",Zc),a.__webglTexture=j.createTexture(),L.info.memory.textures++);j.activeTexture(j.TEXTURE0+b);j.bindTexture(j.TEXTURE_2D,a.__webglTexture);j.pixelStorei(j.UNPACK_FLIP_Y_WEBGL,a.flipY);j.pixelStorei(j.UNPACK_PREMULTIPLY_ALPHA_WEBGL,a.premultiplyAlpha);j.pixelStorei(j.UNPACK_ALIGNMENT,a.unpackAlignment);var c=a.image,d=0===(c.width&c.width-1)&&0===(c.height&c.height-1),e=F(a.format),
f=F(a.type);X(j.TEXTURE_2D,a,d);var g=a.mipmaps;if(a instanceof THREE.DataTexture)if(0<g.length&&d){for(var h=0,i=g.length;h<i;h++)c=g[h],j.texImage2D(j.TEXTURE_2D,h,e,c.width,c.height,0,e,f,c.data);a.generateMipmaps=!1}else j.texImage2D(j.TEXTURE_2D,0,e,c.width,c.height,0,e,f,c.data);else if(a instanceof THREE.CompressedTexture){h=0;for(i=g.length;h<i;h++)c=g[h],j.compressedTexImage2D(j.TEXTURE_2D,h,e,c.width,c.height,0,c.data)}else if(0<g.length&&d){h=0;for(i=g.length;h<i;h++)c=g[h],j.texImage2D(j.TEXTURE_2D,
...
j.createTexture();L.info.memory.textures++;var c=0===(a.width&a.width-1)&&0===(a.height&a.height-1),d=F(a.format),e=F(a.type);if(b){a.__webglFramebuffer=[];a.__webglRenderbuffer=[];j.bindTexture(j.TEXTURE_CUBE_MAP,a.__webglTexture);X(j.TEXTURE_CUBE_MAP,a,c);for(var f=0;6>f;f++){a.__webglFramebuffer[f]=j.createFramebuffer();a.__webglRenderbuffer[f]=j.createRenderbuffer();j.texImage2D(j.TEXTURE_CUBE_MAP_POSITIVE_X+f,0,d,a.width,a.height,0,d,e,null);var g=a,h=j.TEXTURE_CUBE_MAP_POSITIVE_X+f;j.bindFramebuffer(j.FRAMEBUFFER,
a.__webglFramebuffer[f]);j.framebufferTexture2D(j.FRAMEBUFFER,j.COLOR_ATTACHMENT0,h,g.__webglTexture,0);A(a.__webglRenderbuffer[f],a)}c&&j.generateMipmap(j.TEXTURE_CUBE_MAP)}else a.__webglFramebuffer=j.createFramebuffer(),a.__webglRenderbuffer=a.shareDepthFrom?a.shareDepthFrom.__webglRenderbuffer:j.createRenderbuffer(),j.bindTexture(j.TEXTURE_2D,a.__webglTexture),X(j.TEXTURE_2D,a,c),j.texImage2D(j.TEXTURE_2D,0,d,a.width,a.height,0,d,e,null),d=j.TEXTURE_2D,j.bindFramebuffer(j.FRAMEBUFFER,a.__webglFramebuffer),
...
void 0,s=a[g[i]].x,r=a[g[i]].y,n=a[g[k]].x,q=a[g[k]].y,z=a[g[l]].x,t=a[g[l]].y;if(1E-10>(n-s)*(t-r)-(q-r)*(z-s))p=!1;else{var B=void 0,G=void 0,D=void 0,w=void 0,I=void 0,J=void 0,E=void 0,X=void 0,A=void 0,S=void 0,A=X=E=u=x=void 0,B=z-n,G=t-q,D=s-z,w=r-t,I=n-s,J=q-r;for(p=0;p<e;p++)if(!(p===i||p===k||p===l))if(x=a[g[p]].x,u=a[g[p]].y,E=x-s,X=u-r,A=x-n,S=u-q,x-=z,u-=t,A=B*S-G*A,E=I*X-J*E,X=D*u-w*x,0<=A&&0<=X&&0<=E){p=!1;break a}p=!0}}if(p){f.push([a[g[i]],a[g[k]],a[g[l]]]);h.push([g[i],g[k],g[l]]);
